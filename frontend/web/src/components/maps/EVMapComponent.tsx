...
const EVMapComponent: React.FC<EVMapComponentProps> = ({
  ...
  const mockChargers: EVCharger[] = [
    {
      id: '1',
      name: 'Coimbatore Central Mall - Fast Charging Hub',
      lat: 11.0168,
      lng: 76.9558,
      type: 'fast',
      status: 'available',
    ...
    {
      id: '2',
      name: 'Chennai T Nagar - Ultra Fast',
      lat: 13.0827,
      lng: 80.2707,
      type: 'ultra-fast',
      status: 'occupied',
    ...
    {
      id: '3',
      name: 'Madurai Junction - Rapid Charging',
      lat: 9.9252,
      lng: 78.1198,
      type: 'rapid',
      status: 'available',
      ...
      address: 'Railway Junction, Madurai, Tamil Nadu 625001',
    ...
    {
      id: '4',
      name: 'Tiruchirappalli Airport - Express Charging',
      lat: 10.7654,
      lng: 78.7097,
      type: 'fast',
      status: 'maintenance',
      ...
      price: 14.00,
      operator: 'IOCL',
      address: 'Tiruchirappalli International Airport, Tamil Nadu 620007',
