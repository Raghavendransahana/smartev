...
const BatteryCard: React.FC<{ battery: BatteryListingProps }> = ({ battery }) => (
  <Card className="p-6 border-zinc-800 bg-zinc-900 hover:shadow-lg transition-shadow">
    <div className="flex justify-between items-start mb-4">
      <div>
        <h3 className="text-lg font-semibold text-zinc-100">{battery.brand} {battery.model}</h3>
        <p className="text-zinc-400 text-sm">{battery.location}</p>
      </div>
      <Badge 
    ...
    <div className="space-y-3 mb-4">
      <div className="flex items-center justify-between text-sm">
        ...
        <span className="text-zinc-100">{battery.remainingLife}</span>
      </div>
      <div className="flex items-center justify-between text-sm">
        <span className="text-zinc-400">CO₂ Impact:</span>
        <span className="text-emerald-400">-{battery.eco_impact.co2_saved}kg</span>
      </div>
      <div className="flex items-center justify-between text-sm">
        <span className="text-zinc-400">Price:</span>
        <span className="text-zinc-100 font-semibold">${battery.price.toLocaleString()}</span>
      </div>
    </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-zinc-100">Seller Dashboard</h1>
          <p className="text-zinc-400">Battery marketplace and eco-impact analytics</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="p-6 border-zinc-800 bg-zinc-900">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-zinc-100">$47,350</p>
        ...
        <Card className="p-6 border-zinc-800 bg-zinc-900">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <p className="text-zinc-400 text-sm">Batteries Sold</p>
        ...
        <Card className="p-6 border-zinc-800 bg-zinc-900">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <p className="text-zinc-400 text-sm">CO₂ Saved</p>
              <p className="text-2xl font-bold text-zinc-100">1,247kg</p>
        ...
        <Card className="p-6 border-zinc-800 bg-zinc-900">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-zinc-100">$2,368</p>
        ...
        <Card className="p-6 border-zinc-800 bg-zinc-900">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <span className="text-zinc-300">Total CO₂ Reduced</span>
              <span className="text-emerald-400 font-semibold">1,247 kg</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-zinc-300">Batteries Recycled</span>
              <span className="text-emerald-400 font-semibold">23 units</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-zinc-300">Eco Score</span>
        ...
        <Card className="p-6 border-zinc-800 bg-zinc-900">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="text-zinc-100 font-semibold">$8,450</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-zinc-300">Average Sale</span>
              <span className="text-zinc-100 font-semibold">$2,063</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-zinc-300">Best Seller</span>
              <span className="text-zinc-100 font-semibold">Tesla Batteries</span>
            </div>
            <div className="pt-2 border-t border-zinc-800">
              <div className="flex items-center justify-between">
                <span className="text-zinc-300 text-sm">Growth Rate</span>
